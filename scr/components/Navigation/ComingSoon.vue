<template>
  <div>
    ...
    <ul class="mui-table-view">
      <li class="mui-table-view-cell mui-media" v-for="item in ComingSoonList" :key="item.id">
...
export default {
  ...
  methods: {
    getLists() {
      this.$http
        .jsonp("https://douban.uieee.com/v2/movie/coming_soon")
        .then(res => {
          if (res.status === 200) {
            this.ComingSoonList = res.body.subjects;
